...
namespace HitsukayaCart\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use HitsukayaCart\Scaffold\Module\Generators\FilesGenerator;
use HitsukayaCart\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \HitsukayaCart\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \HitsukayaCart\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \HitsukayaCart\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \HitsukayaCart\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The HitsukayaCart {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The HitsukayaCart {$moduleName} Module.\"," . PHP_EOL;
