...
$(function () {
    ...
    var o = $.HitsukayaCart.options;

    // Set up the object
    _init();

    // Activate layout
    $.HitsukayaCart.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.HitsukayaCart.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.HitsukayaCart.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the HitsukayaCart Object -
   ---------------------------------- */
function _init() {

    // Layout
    $.HitsukayaCart.layout = {
        activate: function () {
            var _this = this;
            _this.fix();
    ...
    // PushMenu
    $.HitsukayaCart.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.HitsukayaCart.options.screenSizes;
    ...
    // Tree
    $.HitsukayaCart.tree = function (menu) {
        var animationSpeed = $.HitsukayaCart.options.animationSpeed;
