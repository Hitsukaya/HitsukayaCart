...
class Permission
{
    ...
    private static function getEnabledModulePermissions()
    {
        ...
        foreach (Module::allEnabled() as $module) {
            $config = config('HitsukayaCart.modules.' . strtolower($module->getName()) . '.permissions');
    ...
    {
        $permissions = config('HitsukayaCart.themes.' . strtolower(setting('active_theme')) . '.permissions');
