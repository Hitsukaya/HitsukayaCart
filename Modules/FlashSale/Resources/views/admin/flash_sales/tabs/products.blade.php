...
@push('globals')
    <script>
        HitsukayaCart.data['flash_sale.products'] = {!! old_json('products', $flashSale->products) !!};
        HitsukayaCart.errors['flash_sale.products'] = @json($errors->get('products.*'), JSON_FORCE_OBJECT);
    </script>
@endpush
