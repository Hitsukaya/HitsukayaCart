...
use HitsukayaCart\HitsukayaCart;
...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('HitsukayaCart.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('HitsukayaCart_version')) {
    /**
     * Get the HitsukayaCart version.
     *
     * @return string
     */
    function HitsukayaCart_version()
    {
        return HitsukayaCart::VERSION;
    }
}
